...
<div class="container" style="font-family: 微软雅黑;">
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <br/>
            <form class="form-horizontal" role="form" action="/admin/doLogin" method="post" id="loginForm" style="margin-left: 346px;font-family: 微软雅黑;">
                <div class="form-group">
                    <label class="col-sm-2 control-label">用户名</label>
                    <div class="col-sm-10">
                        <input required type="text" class="form-control" name="username" id="username" style="width: 390px;"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input required type="text" class="form-control" name="code" id="imageCodeIn" style="width: 390px;"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">密码</label>
                    <div class="col-sm-10">
                        <input type="password" class="form-control" name="password" id="password" style="width: 390px;"/>
                    </div>
                </div>
                <div class="form-group">
